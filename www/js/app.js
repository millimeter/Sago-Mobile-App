...
$$(document).on('page:init', '.page[data-name="userProfile"]', function (e) {
    getUserDetails();
});

$$(document).on('page:init', '.page[data-name="pwd"]', function (e) {
    openForgot();
});
...
$$(document).on('page:init', '.page[data-name="qrcode"]', function (e) {

    //processOrder(localStorage.getItem('orderNumber'))
...
$$(document).on('page:init', '.page[data-name="_shop_in"]', function (e) {
    getShops('_shop_in');
});
